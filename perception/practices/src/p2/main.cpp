...
main(int argc,char **argv)
{
	...
	try{
		Image I1;
		I1.loadFromFile("leopardo.pgm");
		
		//Load image
		Image I(100,100); //100x100 grey
		I=30;
		I1=I;
		I.saveToFile("i30.ppm");
		I1.saveToFile("copiai30.ppm");
		Image I2(I);
		
		I1.loadFromFile("leopardo.pgm");
		I1.saveToFile("leo.ppm");
	...
	try{
		//Load image
		Image I10(1024,1024,1); //100x100 grey
		int k = 0;
